...
//honestly this was the easiest thing
//just make the same changes as you had in good_philosophers1.c
//and implement them and this works for an arbitor solution
   ...
   {  // In this version of the "philosopher program", the philosopher
      ...
      while (1)
         { // Philosophers always think before they eat.  They need to 
		   ...
		   //they are good now!!!!
           printf ("Good Philosopher %d wants chopsticks %d and %d\n",
                    philosopher_number,
                    i_want_this,
                    i_want_this_too);
		   //make it so only 1 person at a time can eat 
		   pthread_mutex_lock(&waiter);
           pthread_mutex_lock(&chopstick[i_want_this]);
           pthread_mutex_lock(&chopstick[i_want_this_too]);
		   pthread_mutex_unlock(&waiter);
           
           // Hurray, if I got this far I'm eating and they are good!!!
           printf ("Good Philosopher %d is eating with chopsticks %d and %d\n",
                   philosopher_number,
                   i_want_this,
                   i_want_this_too);
